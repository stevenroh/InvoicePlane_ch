...
<body>
    <header class="clearfix">
        ...
        <div id="company">
            ...
            if ($quote->user_email) {
                echo '<div>' . htmlsc($quote->user_email) . '</div>';
            }
            if ($quote->user_phone) {
                echo '<div>' . htmlsc($quote->user_phone) . '</div>';
            }
            if ($quote->user_fax) {
    ...
    <main>
        ...
        <table class="item-table">
            ...
            <tbody class="invoice-sums">
                ...
                <tr>
                    <td <?php echo ($show_item_discounts ? 'colspan="5"' : 'colspan="4"'); ?> class="text-right"><?php _trans('subtotal'); ?></td>
